...
training_set = train_datagen.flow_from_directory('training',target_size=(64,64),batch_size = 32 ,
...
test_image = image.load_img('prediction/sunflower1.jpeg',target_size = (64,64))
